...
def heatmap():
    ...
    hwindow1.setWindowTitle("Parkinson Prediction ")
...
def attribute():
    ...
    awindow1.setWindowTitle("Parkinson Prediction")
    awindow1.setStyleSheet("background : rgb(200,255,255)")
    awindow1.show()
    alabel1 = QLabel(awindow1)
    alabel1.setPixmap(QPixmap("black.png"))
...
def piechart():
    ...
    pwindow1.setWindowTitle("Parkinson Prediction ")
...
def scatter():
    ...
    swindow1.setWindowTitle("Parkinson Prediction ")
...
def linechart():
    ...
    lwindow1.setWindowTitle("Parkinson Prediction")
...
def inputpage2():
    ...
    hlabel.setText("PARKINSON DISEASE PREDICTION")
...
window.setWindowTitle("Parkinson Prediction")
print(w, h)
...
label = QLabel(frame)
label.setPixmap(QPixmap("loginback.jpg"))
...
label1.setPixmap(QPixmap("backk.jpg"))
